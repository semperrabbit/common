Object.assign(exports, {
    ...
    RANGE_ENABLE_POWER: 1,
    RANGE_PWR_OPERATE_SPAWN: 3,
    RANGE_PWR_OPERATE_TOWER: 3,
    RANGE_PWR_OPERATE_STORAGE: 3,
    RANGE_PWR_OPERATE_LAB: 3
    RANGE_PWR_OPERATE_EXTENSION: 3,
    RANGE_PWR_OPERATE_OBSERVER: 3,
    RANGE_PWR_OPERATE_TERMINAL: 3,
    RANGE_PWR_DISRUPT_SPAWN: 20,
    RANGE_PWR_DISRUPT_TOWER: 50,
    RANGE_PWR_DISRUPT_SOURCE: 3,
    RANGE_PWR_REGEN_SOURCE: 3,
    RANGE_PWR_REGEN_MINERAL: 3,
    RANGE_PWR_DISRUPT_TERMINAL: 50,
    RANGE_PWR_FORTIFY: 3,
    RANGE_PWR_OPERATE_POWER: 3,
    RANGE_PWR_OPERATE_CONTROLLER: 3,
    RANGE_PWR_OPERATE_FACTORY: 3,
...
Object.assign(exports, {
    POWER_INFO: {
        ...
        [exports.PWR_OPERATE_SPAWN]: {
            ...
            cooldown: 300,
            duration: 1000,
            range: exports.RANGE_PWR_OPERATE_SPAWN,
            ops: 100,
        ...
        [exports.PWR_OPERATE_TOWER]: {
            ...
            cooldown: 10,
            duration: 100,
            range: exports.RANGE_PWR_OPERATE_TOWER,
            ops: 10,
        ...
        [exports.PWR_OPERATE_STORAGE]: {
            ...
            cooldown: 800,
            duration: 1000,
            range: exports.RANGE_PWR_OPERATE_STORAGE,
            ops: 100,
        ...
        [exports.PWR_OPERATE_LAB]: {
            ...
            cooldown: 50,
            duration: 1000,
            range: exports.RANGE_PWR_OPERATE_LAB,
            ops: 10,
            effect: [2,4,6,8,10]
        },
        [exports.PWR_OPERATE_EXTENSION]: {
            ...
            level: [0, 2, 7, 14, 22],
            cooldown: 50,
            range: exports.RANGE_PWR_OPERATE_EXTENSION,
            ops: 2,
        ...
        [exports.PWR_OPERATE_OBSERVER]: {
            ...
            range: exports.RANGE_PWR_OPERATE_OBSERVER,
            ops: 10,
        },
        [exports.PWR_OPERATE_TERMINAL]: {
            ...
            cooldown: 500,
            duration: 1000,
            range: exports.RANGE_PWR_OPERATE_TERMINAL,
            ops: 100,
        ...
        [exports.PWR_DISRUPT_SPAWN]: {
            ...
            level: [0, 2, 7, 14, 22],
            cooldown: 5,
            range: exports.RANGE_PWR_DISRUPT_SPAWN,
            ops: 10,
            duration: [1,2,3,4,5]
        },
        [exports.PWR_DISRUPT_TOWER]: {
            ...
            cooldown: 0,
            duration: 5,
            range: exports.RANGE_PWR_DISRUPT_TOWER,
            ops: 10,
            effect: [0.9, 0.8, 0.7, 0.6, 0.5],
        },
        [exports.PWR_DISRUPT_SOURCE]: {
            ...
            level: [0, 2, 7, 14, 22],
            cooldown: 100,
            range: exports.RANGE_PWR_DISRUPT_SOURCE,
            ops: 100,
        ...
        [exports.PWR_REGEN_SOURCE]: {
            ...
            cooldown: 100,
            duration: 300,
            range: exports.RANGE_PWR_REGEN_SOURCE,
        ...
        [exports.PWR_REGEN_MINERAL]: {
            ...
            cooldown: 100,
            duration: 100,
            range: exports.RANGE_PWR_REGEN_MINERAL,
            effect: [2,4,6,8,10],
            period: 10
        },
        [exports.PWR_DISRUPT_TERMINAL]: {
            ...
            cooldown: 8,
            duration: 10,
            range: exports.RANGE_PWR_DISRUPT_TERMINAL,
            ops: [50,40,30,20,10]
        ...
        [exports.PWR_FORTIFY]: {
            ...
            level: [0, 2, 7, 14, 22],
            cooldown: 5,
            range: exports.RANGE_PWR_FORTIFY,
            ops: 5,
            duration: [1, 2, 3, 4, 5]
        },
        [exports.PWR_OPERATE_POWER]: {
            ...
            level: [10, 11, 12, 14, 22],
            cooldown: 800,
            range: exports.RANGE_PWR_OPERATE_POWER,
            duration: 1000,
            ops: 200,
            effect: [1, 2, 3, 4, 5]
        },
        [exports.PWR_OPERATE_CONTROLLER]: {
            ...
            level: [20, 21, 22, 23, 24],
            cooldown: 800,
            range: exports.RANGE_PWR_OPERATE_CONTROLLER,
            duration: 1000,
            ops: 200,
        ...
        [exports.PWR_OPERATE_FACTORY]: {
            ...
            level: [0, 2, 7, 14, 22],
            cooldown: 1000,
            range: exports.RANGE_PWR_OPERATE_FACTORY,
            duration: 800,
            ops: 100
        },
    },
